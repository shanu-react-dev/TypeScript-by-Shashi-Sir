...
//! IIFE Functions
//? IIFE stands for Immediate Invoked Function Expression is a JS function that runs as soon as it is defined. It is common design pattern used to create a private scope and prevent variables from leaking into the global name space. It will be executed only once in a webpage.
//todo what is global pollution
//todo what is minification and unminification
//! Notable things
//?1 It will get executed only once
//?2 It must and should be terminated using semicolon.
