...
let courses = [10, 20, 40];
let usersInfo = ["Shanu", "Sundari"];
...
let languages = ["Java", "JS", "Python", "Ruby", "PHP"];
...
let users = [["Shanu"]];
let users1 = [["Sundari"]];
let emp = ["Shanu", "Sailaja", "Surabhi"]; //! Now you are not able to change the value
